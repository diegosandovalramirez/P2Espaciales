...
mz_SII <- read_rds("iquique/mz_SII_iquique.rds") 


## No estoy seguro de que comercia sea realmente MtOfCom pq no lo encuentro
ggplot() +
...
# exploramos los valores de escolaridad
mz_lc$ibt
